...
/**
 * Definition class for table Comment.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Comment_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Comment_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Comment_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Comment_Rowset find()
 *
 */
abstract class Application_Model_Comment_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'id',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Comment_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Comment_Rowset';
  ...
  'Post_id' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['createdAt']) && !empty($params['createdAt'])) {
            $select->where('createdAt = ?', $params['createdAt']);
        }
