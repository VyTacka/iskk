...
/**
 * Definition class for table Page.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Page_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Page_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Page_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Page_Rowset find()
 *
 */
abstract class Application_Model_Page_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'id',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Page_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Page_Rowset';
